...
#define PS_ADC_Clock_31    0x30    //1.55 �s times 2^PS_ADC_GAIN
#define PS_ADC_Clock_63    0x40    //3.15 �s times 2^PS_ADC_GAIN
#define PS_ADC_Clock_127   0x50    //6.35 �s times 2^PS_ADC_GAIN
#define PS_ADC_Clock_255   0x60    //12.75 �s times 2^PS_ADC_GAIN
#define PS_ADC_Clock_511   0x70    //25.55 �s times 2^PS_ADC_GAIN
...
#define VIS_ADC_Clock_63   0x40    //3.15 �s times 2^ALS_VIS_ADC_GAIN
#define VIS_ADC_Clock_127  0x50    //6.35 �s times 2^ALS_VIS_ADC_GAIN
#define VIS_ADC_Clock_255  0x60    //12.75 �s times 2^ALS_VIS_ADC_GAIN
#define VIS_ADC_Clock_511  0x70    //25.55 �s times 2^ALS_VIS_ADC_GAIN
...
#define IR_ADC_Clock_31     0x30    //1.55 �s times 2^ALS_IR_ADC_GAIN
#define IR_ADC_Clock_63     0x40    //3.15 �s times 2^ALS_IR_ADC_GAIN
#define IR_ADC_Clock_127    0x50    //6.35 �s times 2^ALS_IR_ADC_GAIN
#define IR_ADC_Clock_255    0x60    //12.75 �s times 2^ALS_IR_ADC_GAIN
#define IR_ADC_Clock_511    0x70    //25.55 �s times 2^ALS_IR_ADC_GAIN
...
void si1145_init(enum E_Operation operation)
{
    ...
    {
        //Set integration time to 25.6 �s
        //Resolution 6 lx
    ...
    {
        //HIGH_SENSITIVE mode, set integration time to 410 �s
        //Resolution 1 lx
...
static uint16_t si1145_getVisible_raw(void)
{
...
static uint16_t si1145_getIR_raw(void)
{
